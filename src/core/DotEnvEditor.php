<?php
namespace makbari\DotEnvEditor\core;

use makbari\DotEnvEditor\exceptions\DotEnvException;
use makbari\DotEnvEditor\exceptions\InvalidPathException;
use makbari\DotEnvEditor\services\Config;

/**
 * Class DotenvEditor
 * @package makbari\DotEnvEditor\core
 */
class DotEnvEditor
{
    /**
    ...
    public function __construct($configPath)
    {
        ...
        $backupPath = $this->config->get('dotenveditor.backupPath');
        $env = $this->config->get('dotenveditor.pathToEnv');
    ...
    public function getValue($key)
    {
        if($this->keyExists($key)){
            ...
            throw new DotEnvException('dotenv-editor::class.requested_value_not_available', 0);
        }
    }
    ...
    public function setAutoBackup($onOff)
    {
        if(is_bool($onOff)){
            ...
            throw new DotEnvException('dotenv-editor::class.autobackup_wrong_value', 0);
        }
    }
    ...
    */
    ...
    protected function getFile($timestamp)
    {
        ...
        if(file_exists($file)){
            ...
            throw new DotEnvException('dotenv-editor::class.requested_backup_not_found', 0);
        }
    ...
    public function getBackupVersions()
    {
        ...
        throw new DotEnvException('dotenv-editor::class.no_backups_available', 0);
    }
    ...
    public function deleteBackup($timestamp)
    {
        ...
        if(file_exists($file)){
            ...
            throw new DotEnvException('dotenv-editor::class.backup_not_deletable', 0);
        }
    }
    ...
    */
    ...
    public function changeEnv($data = array())
    {
        ...
        throw new DotEnvException('dotenv-editor::class.array_needed', 0);
    }
